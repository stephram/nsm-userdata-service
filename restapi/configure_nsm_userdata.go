...
//go:generate swagger generate server --target ../../nsm-microservice-golang-userdata --name NsmUserdata --spec ../spec/userdata-swagger.yaml --model-package restapi/models

func configureFlags(api *operations.NsmUserdataAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.NsmUserdataAPI) http.Handler {
